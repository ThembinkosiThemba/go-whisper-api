...
import (
	...
	"github.com/ThembinkosiThemba/go-whisper-api/models"
	"github.com/ThembinkosiThemba/go-whisper-api/transcribe"
)
...
func (c *Client) Transcribe(h io.Reader, opts ...transcribe.TranscribeOption) (*models.TranscribeResponse, error) {
	if c.apiKey == "" {
		return nil, errors.New("missing API key (set OPENAI_API_KEY) in env file")
	}
